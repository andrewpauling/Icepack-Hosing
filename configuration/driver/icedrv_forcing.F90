...
! namelist input; initialize the forcing data.
     ...
     !-------------------------------------------------------------------
      ...
      if (trim(atm_data_type(1:4)) == 'ERA5')  call atm_ERA5
...
!=======================================================================
      ...
      subroutine atm_ERA5
         ...
         character (char_len_long) string1
         character (char_len_long) filename
         character(len=*), parameter :: subname='(atm_ERA5)'
   
   !      atm_data_file = 'cfsv2_2015_220_70_01hr.txt'
         filename = trim(data_dir)//'/ERA5/'//trim(atm_data_file)
